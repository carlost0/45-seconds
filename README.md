...
it's a 3d game written in C with my own [ascii graphics library](https://github.com/carlost0/aschii) sadly, it uses SDL2 for sound, but it runs entirely in the terminal!
